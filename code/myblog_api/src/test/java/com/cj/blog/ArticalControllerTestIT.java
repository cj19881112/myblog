...
public class ArticalControllerTestIT {
	...
	public void testGetArtical_returnAll() throws ParseException {
		...
		// TODO 比较的时候有问题
		// assertThat(artical.getBody().getData().get(0)).isEqualTo(new Artical(4,
		// "world", "/abc", "hello", "hello world",
		// 1, "nice,job", sdf.parse("2018-01-01 00:00:02"), "0"));
		// assertThat(artical.getBody().getData().get(1)).isEqualTo(new Artical(3,
		// "world", "/abc", "hello", "hello world",
		// 1, "hi", sdf.parse("2018-01-01 00:00:01"), "0"));
		// assertThat(artical.getBody().getData().get(2)).isEqualTo(new Artical(2,
		// "hello", "/abc", "hello", "hello world",
		// 1, "hi", sdf.parse("2018-01-01 00:00:00"), "0"));
	}
